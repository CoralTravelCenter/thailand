...
* ```yarn run prettify:stylus``` - привести файлы стилей в сообветствие с кодгайдом
* ```yarn run inline``` - преобразование файлов Js и CSS проекта в inline в HTML, преобразованные файлы /dist/*.inline.html
