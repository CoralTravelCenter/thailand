...
gulp.task('inline_sunmar', function() {
    return gulp
        ...
        .pipe(rep({
            prependSrc : '//cdn.sunmar.ru/content/cms/russia/thailand/',
            keepOrigin : false
        }))
        .pipe(fileInline())
        .pipe(replace("<html><head></head><body>", ""))
        .pipe(replace("</body></html>", ""))
        .pipe(replace("./img/content/sunmar/", "//cdn.sunmar.ru/content/cms/russia/thailand/"))
        .pipe(replace("img/content/sunmar/", "//cdn.coral.ru/content/cms/russia/thailand/"))
